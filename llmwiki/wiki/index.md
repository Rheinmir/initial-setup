...
| [020726-council-chon-de-thi-self-index](sources/draft/archive/analysis/020726-council-chon-de-thi-self-index.md) | draft | Dựng app mẫu TS ngoài mẫu để council tự chọn đề thi, harass 8 loại vector quan hệ chống ludic fallacy (superseded → GH#81) |
...
| [030726-narrative-as-data](sources/draft/archive/proposals/030726-narrative-as-data.md) | draft | Rút narrative cơ-chế-phòng-thủ của overstack.html khỏi prose tay thành manifest mechanisms.yaml + medic probe narrative-drift cắn khi lệch |
...
| [080926-prd-grade-fe-PLAN](sources/draft/archive/proposals/080926-prd-grade-fe-PLAN.md) | draft | /prd-grade-fe — PLAN thi hành |
...
| [090926-fdk-gate-two-stale-steps](sources/draft/archive/analysis/090926-fdk-gate-two-stale-steps.md) | issue | Issue: fdk-gate 2 step đỏ tồn từ ddd366d — 9 wikilink trỏ mirror skills đã bỏ, task T-260908-01 chưa đăng ký; kéo theo R7 trên 2 proposal cũ đã ship (GH#146) |
| [090926-skills-sync-provenance-stale](sources/draft/archive/analysis/090926-skills-sync-provenance-stale.md) | issue | Issue: skills-sync đỏ 2 ngày/3 commit vì sổ skill-provenance không được record sau khi sửa skill — đã record lại + thêm hook pre-commit cắn sớm (GH#144) |
| [090926-index-sync-untracked-hole](sources/draft/archive/analysis/090926-index-sync-untracked-hole.md) | issue | Issue: index_sync xanh ở máy đỏ trên CI vì index.md trỏ file chưa git add — đã bịt lỗ untracked, và tập tracked rỗng phải coi như không có git (GH#145) |
| [200726-code-graph-index-broken](sources/draft/archive/analysis/200726-code-graph-index-broken.md) | issue | Issue: code-graph MCP hỏng do 1 database thiếu schema giết cả fan-out truy vấn + list_projects lộ tên file thay tên repo — đã sửa bằng guard is_usable_db() |
...
| [210721-decision-anchoring](sources/draft/archive/proposals/210721-decision-anchoring.md) | draft | Neo quyết định vào symbol code (không chỉ file), 4 trạng thái LIVE/STALE/ORPHAN/UNAVAILABLE suy từ code-graph — mở rộng mechanisms.yaml xuống mức symbol |
| [210721-decision-anchoring-PLAN](sources/draft/archive/proposals/210721-decision-anchoring-PLAN.md) | draft | Plan thi hành decision-anchoring T1-T8: engine decision-liveness.py đọc trực tiếp index.db (không qua MCP), checksum-freshness thay is_file(), test trên sandbox |
| [220722-artifact-provenance-eventlog](sources/draft/archive/proposals/220722-artifact-provenance-eventlog.md) | draft | Thiết kế event log Kafka-pattern git-native cho artifact-provenance: sổ sự kiện đa-writer merge qua git branch, chọn CAP=AP, tương quan code↔docs |
| [220722-artifact-provenance-eventlog-PLAN](sources/draft/archive/proposals/220722-artifact-provenance-eventlog-PLAN.md) | draft | PLAN thi hành T1-T5 (T6 hoãn, chờ trả nợ U-05): adapter provenance-log.py, merge=union, wiring decision-anchoring + Stop hook |
...
| [030826-evidence-terminal-chain-PLAN](sources/draft/archive/proposals/030826-evidence-terminal-chain-PLAN.md) | draft | PLAN thi hành 9 task cho luật R19 evidence-terminal — validator đồ thị chuỗi chứng cứ, 6 loại điểm cuối (web đòi link+ngày+trích, parametric đòi origin và cấm đứng một mình), công tắc bật/tắt ba tầng tắt-vẫn-báo, bite-test + wire CI |
...
| [110926-seq-html-slop-gate](sources/110926-seq-html-slop-gate.md) | source | Sự cố trang seq html chỉ là danh sách bước (0 sơ đồ) vẫn qua R7/R11 vì cổng đếm class và marker CSS thay vì soi hình; sửa bằng R7(c) chỉ tính artifact archify và /propose vẽ qua /diagram, kèm số đo chi phí token |
...
| [080926-archify-fork-pin](sources/draft/080926-archify-fork-pin.md) | draft | Docs overstack khai nguồn cài engine sơ đồ là `tt-a1i/archify` nhưng máy dev đã pin sang fork `Rheinmir/archify` @ `macos-roboto` (preset macos + Roboto làm mặc định); sửa 2 dòng canonical `skills/diagram/SKILL.md` rồi sync, và nêu cấu trúc sinh drift: pin chỉ là văn xuôi, không có gì đối chiếu với `.skill-lock.json`.
