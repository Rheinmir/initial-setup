...
| [080926-provenance-scope-test-cries-wolf](sources/draft/080926-provenance-scope-test-cries-wolf.md) | issue | Test `skill-provenance-scope-test.sh:66` đo trạng thái tuyệt đối của `git status -- skills/` thay vì hiệu số trước/sau, nên báo đỏ khi working tree vốn đã bẩn; local đỏ giả trong khi CI xanh thật, làm mòn niềm tin vào một cổng còn cắn được.
| [080926-flush-khong-kem-distill](sources/draft/080926-flush-khong-kem-distill.md) | issue | Hook R17 tự ghi thẻ p-auto nhưng chưng lọc thì trông vào người nhớ, nên nợ tồn hàng tuần; kèm lỗi ghi trùng thẻ khi SessionEnd bắn hai lần cho một phiên. Đã dọn backlog, chốt idempotent theo session, và gắn probe medic đếm thẻ pending làm vòng phản hồi cho vế dọn.
