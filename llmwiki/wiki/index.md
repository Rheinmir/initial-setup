...
| [090926-fdk-gate-two-stale-steps](sources/draft/090926-fdk-gate-two-stale-steps.md) | issue | Issue: fdk-gate 2 step đỏ tồn từ ddd366d — 9 wikilink trỏ mirror skills đã bỏ, task T-260908-01 chưa đăng ký; kéo theo R7 trên 2 proposal cũ đã ship (GH#146) |
| [090926-skills-sync-provenance-stale](sources/draft/090926-skills-sync-provenance-stale.md) | issue | Issue: skills-sync đỏ 2 ngày/3 commit vì sổ skill-provenance không được record sau khi sửa skill — đã record lại + thêm hook pre-commit cắn sớm (GH#144) |
| [090926-index-sync-untracked-hole](sources/draft/090926-index-sync-untracked-hole.md) | issue | Issue: index_sync xanh ở máy đỏ trên CI vì index.md trỏ file chưa git add — đã bịt lỗ untracked, và tập tracked rỗng phải coi như không có git (GH#145) |
