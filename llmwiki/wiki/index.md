...
| [200826-docs-site-macos-mermaid-sidebar-fix](draft/unknown/200826-docs-site-macos-mermaid-sidebar-fix.md) | unknown-ledger | U-01: chưa xác nhận beautiful-mermaid (dist/index.js ESM) chạy thẳng trong `<script>` trình duyệt self-contained hay cần tự bundle esbuild — default đang giả định cần bundle, rủi ro high |
