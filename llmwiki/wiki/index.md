...
| [030826-session-provenance](sources/030826-session-provenance.md) | source | Auto-distill scratch-log phiên b8afb386 ngày 03/08 — verify installer đăng ký hook vào ~/.openclaude: vá 3 lỗi (trục trặc phía OpenClaude bóp chết cài Claude global, ghi atomic siết quyền 644→600, chữ có dấu bị escape), test 25/25 + wire CI |
| [050826-session-provenance](sources/050826-session-provenance.md) | source | Auto-distill scratch-log phiên b8afb386 ngày 05/08 — thi hành trọn luật R19 evidence-terminal (9 task, bật strict sau khi đo báo oan 0/2, bịt cổng câm ở post_tool_use và lỗi suy root ở bản deploy tier-2), gỡ 3 cổng pre-push, và chuyển model mặc định opencode sang ctd/gpt-5.6-terra |
...
| [060826-session-provenance](sources/060826-session-provenance.md) | source | Auto-distill scratch-log phiên b8afb386 ngày 06/08 — viết runbook setup OpenClaude+OpenCode (token tách ra ngoài repo), gỡ provider orcaflow chết, và chẩn đoán refusal 0-token trên CoopCons: chỉ nhánh gpt-5.6-sol dính, còn khoá `model` trong settings openclaude bị bỏ qua |
| [070826-session-provenance](sources/070826-session-provenance.md) | source | Auto-distill scratch-log phiên b8afb386 ngày 07/08 — vá GH_HOME khiến install.sh crash khi thiếu --with-wiki, symlink skill cho openclaude (trước đó thấy 0 skill), và đo ra anti-idle KHÔNG chặn được trên OpenClaude vì runtime không có khái niệm block-stop |
